...
#BALLET CLASSES
mummy_class = BalletClass.create!(ballet_level_id: 1, class_name: 'mummy and me class')
preschool_class = BalletClass.create!(ballet_level_id: 2, class_name: 'preschool_class') 
pre_primary_class = BalletClass.create!(ballet_level_id: 3, class_name: 'pre_primary_class')
primary_class = BalletClass.create!(ballet_level_id: 4, class_name: 'primary_class')
grade_1_class = BalletClass.create!(ballet_level_id: 5, class_name: 'grade_1_class')
grade_2_class = BalletClass.create!(ballet_level_id: 6, class_name: 'grade_2_class')
grade_3_class = BalletClass.create!(ballet_level_id: 7, class_name: 'grade_3_class')
grade_4_class = BalletClass.create!(ballet_level_id: 8, class_name: 'grade_4_class')
intermediate_foundation_class = BalletClass.create!(ballet_level_id: 11, class_name: 'intermediate_foundation_class')
intermediate_class = BalletClass.create!(ballet_level_id: 12, class_name: 'intermediate_class')
advanced_foundation_class = BalletClass.create!(ballet_level_id: 13, class_name: 'advanced_foundation_class')
booty_barre_class = BalletClass.create!(ballet_level_id: 14, class_name: 'booty_barre_class')
open_class = BalletClass.create!(ballet_level_id: 15, class_name: 'open_class')
discovering_rep_class = BalletClass.create!(ballet_level_id: 16, class_name: 'discovering_rep_class')
...
ClassTime.create!(timetable_id: Timetable.first.id, ballet_class_id: 9, day_of_week: "Monday", start_time: "5:15pm", end_time: "6:30pm")
ClassTime.create!(timetable_id: Timetable.first.id, ballet_class_id: 10, day_of_week: "Monday", start_time: "6:30pm", end_time: "7:45pm")
