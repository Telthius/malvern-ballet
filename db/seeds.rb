...
#BALLET CLASSES
mummy_class = BalletClass.create!(ballet_level_id: 1, class_name: 'mummy and me class', timetable_id: timetable_1.id)
preschool_class = BalletClass.create!(ballet_level_id: 2, class_name: 'preschool_class', timetable_id: timetable_1.id) 
pre_primary_class = BalletClass.create!(ballet_level_id: 3, class_name: 'pre_primary_class', timetable_id: timetable_1.id)
primary_class = BalletClass.create!(ballet_level_id: 4, class_name: 'primary_class', timetable_id: timetable_1.id)
grade_1_class = BalletClass.create!(ballet_level_id: 5, class_name: 'grade_1_class', timetable_id: timetable_1.id)
grade_2_class = BalletClass.create!(ballet_level_id: 6, class_name: 'grade_2_class', timetable_id: timetable_1.id)
grade_3_class = BalletClass.create!(ballet_level_id: 7, class_name: 'grade_3_class', timetable_id: timetable_1.id)
grade_4_class = BalletClass.create!(ballet_level_id: 8, class_name: 'grade_4_class', timetable_id: timetable_1.id)
intermediate_foundation_class = BalletClass.create!(ballet_level_id: 11, class_name: 'intermediate_foundation_class', timetable_id: timetable_1.id)
intermediate_class = BalletClass.create!(ballet_level_id: 12, class_name: 'intermediate_class', timetable_id: timetable_1.id)
advanced_foundation_class = BalletClass.create!(ballet_level_id: 13, class_name: 'advanced_foundation_class', timetable_id: timetable_1.id)
booty_barre_class = BalletClass.create!(ballet_level_id: 14, class_name: 'booty_barre_class', timetable_id: timetable_1.id)
open_class = BalletClass.create!(ballet_level_id: 15, class_name: 'open_class', timetable_id: timetable_1.id)
discovering_rep_class = BalletClass.create!(ballet_level_id: 16, class_name: 'discovering_rep_class', timetable_id: timetable_1.id)

#CLASSTIMES
ClassTime.create!(ballet_class_id: 2, day_of_week: "Saturday", start_time: "10:00am", end_time: "10:30am")
ClassTime.create!(ballet_class_id: 3, day_of_week: "Saturday", start_time: "10:30am", end_time: "11:15am")
ClassTime.create!(ballet_class_id: 5, day_of_week: "Saturday", start_time: "11:15am", end_time: "12:00pm")
ClassTime.create!(ballet_class_id: 11, day_of_week: "Saturday", start_time: "12:00pm", end_time: "1:30pm")
ClassTime.create!(ballet_class_id: 4, day_of_week: "Monday", start_time: "3:30pm", end_time: "4:15pm")
ClassTime.create!(ballet_class_id: 5, day_of_week: "Monday", start_time: "4:15pm", end_time: "5:15pm")
ClassTime.create!(ballet_class_id: 9, day_of_week: "Monday", start_time: "5:15pm", end_time: "6:30pm")
ClassTime.create!(ballet_class_id: 10, day_of_week: "Monday", start_time: "6:30pm", end_time: "7:45pm")
ClassTime.create!(ballet_class_id: 13, day_of_week: "Tuesday", start_time: "4:45pm", end_time: "6:00pm")
ClassTime.create!(ballet_class_id: 9, day_of_week: "Tuesday", start_time: "6:10pm", end_time: "7:20pm")
ClassTime.create!(ballet_class_id: 1, day_of_week: "Wednesday", start_time: "10:00am", end_time: "10:20")
ClassTime.create!(ballet_class_id: 2, day_of_week: "Wednesday", start_time: "11:00am", end_time: "11:30am")
ClassTime.create!(ballet_class_id: 13, day_of_week: "Wednesday", start_time: "5:30pm", end_time: "6:30pm")
ClassTime.create!(ballet_class_id: 11, day_of_week: "Wednesday", start_time: "6:45pm", end_time: "8:00pm")
ClassTime.create!(ballet_class_id: 7, day_of_week: "Thursday", start_time: "4:30pm", end_time: "5:30pm")
ClassTime.create!(ballet_class_id: 6, day_of_week: "Thursday", start_time: "3:30pm", end_time: "4:30pm")
ClassTime.create!(ballet_class_id: 8, day_of_week: "Thursday", start_time: "5:30pm", end_time: "6:30pm")
ClassTime.create!(ballet_class_id: 6, day_of_week: "Friday", start_time: "3:30pm", end_time: "4:30pm")
ClassTime.create!(ballet_class_id: 7, day_of_week: "Friday", start_time: "4:30pm", end_time: "5:30pm")
ClassTime.create!(ballet_class_id: 8, day_of_week: "Friday", start_time: "5:30pm", end_time: "6:30pm")
ClassTime.create!(ballet_class_id: 10, day_of_week: "Friday", start_time: "6:30pm", end_time: "7:45pm")
