...
pre_school_price_1 = Cost.create!(ballet_level_id: pre_school.id, amount: 100.00, condition: "1 class per week")
pre_primary_price_1 = Cost.create!(ballet_level_id: pre_primary.id, amount: 125.00, condition: "1 class per week")
primary_price_1 = Cost.create!(ballet_level_id: primary.id, amount: 135.00, condition: "1 class per week")
...
grade_2_price_1 = Cost.create!(ballet_level_id: grade_2.id, amount: 275.00, condition: "2 classes per week")
grade_2_price_2 = Cost.create!(ballet_level_id: grade_2.id, amount: 137.50, condition: "1 class per week (for those not sitting exams)")
grade_3_price_1 = Cost.create!(ballet_level_id: grade_3.id, amount: 275.00, condition: "2 classes per week")
grade_3_price_2 = Cost.create!(ballet_level_id: grade_3.id, amount: 137.50, condition: "1 class per week (for those not sitting exams)")
grade_4_price_1 = Cost.create!(ballet_level_id: grade_4.id, amount: 315.00, condition: "2 classes per week")
grade_4_price_2 = Cost.create!(ballet_level_id: grade_4.id, amount: 157.50, condition: "1 class per week (for those not sitting exams)")
grade_5_price_1 = Cost.create!(ballet_level_id: grade_5.id, amount: 315.00, condition: "2 classes per week")
grade_5_price_2 = Cost.create!(ballet_level_id: grade_5.id, amount: 157.50, condition: "1 class per week (for those not sitting exams)")
grade_6_price_1 = Cost.create!(ballet_level_id: grade_6.id, amount: 350.00, condition: "2 classes per week + 1 optional open class")
intermediate_foundation_price_1 = Cost.create!(ballet_level_id: intermediate_foundation.id, amount: 365.00, condition: "2 classes per week + 1 open class")
intermediate_price_1 = Cost.create!(ballet_level_id: intermediate.id, amount: 365.00, condition: "2 classes per week + 1 open class")
advanced_foundation_price_1 = Cost.create!(ballet_level_id: advanced_foundation.id, amount: 365.00, condition: "2 classes per week + 1 open class")
booty_barre_price_1 = Cost.create!(ballet_level_id: advanced_foundation.id, amount: 16.00, condition: "per class")
...
ClassTime.create!(timetable_id: timetable_1.id, ballet_class_id: grade_1_class.id, day_of_week: "Saturday", start_time: "11:15am", end_time: "12:00pm")
ClassTime.create!(timetable_id: timetable_1.id, ballet_class_id: grade_2_class.id, day_of_week: "Thursday", start_time: "3:30pm", end_time: "4:30pm")
...
ClassTime.create!(timetable_id: timetable_1.id, ballet_class_id: grade_3_class.id, day_of_week: "Thursday", start_time: "04:30pm", end_time: "5:30pm")
ClassTime.create!(timetable_id: timetable_1.id, ballet_class_id: grade_3_class.id, day_of_week: "Friday", start_time: "4:30pm", end_time: "5:30pm")
...
ClassTime.create!(timetable_id: timetable_1.id, ballet_class_id: grade_4_class.id, day_of_week: "Friday", start_time: "5:30pm", end_time: "6:30pm")
ClassTime.create!(timetable_id: timetable_1.id, ballet_class_id: intermediate_foundation_class.id, day_of_week: "Monday", start_time: "5:15pm", end_time: "6:15pm")
ClassTime.create!(timetable_id: timetable_1.id, ballet_class_id: intermediate_foundation_class.id, day_of_week: "Tuesday", start_time: "6:10pm", end_time: "7:20pm")
ClassTime.create!(timetable_id: timetable_1.id, ballet_class_id: intermediate_class.id, day_of_week: "Monday", start_time: "6:15pm", end_time: "7:30pm")
ClassTime.create!(timetable_id: timetable_1.id, ballet_class_id: intermediate_class.id, day_of_week: "Friday", start_time: "6:30pm", end_time: "7:45pm")
ClassTime.create!(timetable_id: timetable_1.id, ballet_class_id: advanced_foundation_class.id, day_of_week: "Wednesday", start_time: "6:45pm", end_time: "8:00pm")
ClassTime.create!(timetable_id: timetable_1.id, ballet_class_id: advanced_foundation_class.id, day_of_week: "Saturday", start_time: "12:00pm", end_time: "1:30pm")
ClassTime.create!(timetable_id: timetable_1.id, ballet_class_id: open_class.id, day_of_week: "Tuesday", start_time: "4:45pm", end_time: "6:00pm TBC")
ClassTime.create!(timetable_id: timetable_1.id, ballet_class_id: open_class.id, day_of_week: "Wednesday", start_time: "5:30pm", end_time: "6:30pm TBC")
